...
analyse_genomes.find_genes_alignment("significant_lines_from_kmer_coeff_file.txt", SPECIES , ANTIBIOTIC, ref_genome_file = REFSEQ)
...
# straight = analyse_genomes.straighten_DNA("/home/sass/Dev/PhenotypeSeeker/EnterococcusFaecium/Vancomycin/Genomes/enterococcus_faecium__vancomycin/0_1352.9653.fna")

# print(analyse_genomes.find_all_indexes(straight, "AAACATTAAAAGA".lower()))
# print(analyse_genomes.find_all_indexes(straight, analyse_genomes.reverse_complement("AAACATTAAAAGA").lower()))
